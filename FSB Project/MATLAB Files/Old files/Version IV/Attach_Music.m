...
for i = 1:120
    ...
    if (exist(Music_Path_String, 'file') == 2)  % If this file exists,
        ...
        Final_page = Initial_page+floor(length(Music_vector)/flash_page_size);   % Final page index is derived based on the length of the music file to be attached.
        % First page is reserved for saving the page indexes.
