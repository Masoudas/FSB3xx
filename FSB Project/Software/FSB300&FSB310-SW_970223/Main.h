...
unsigned int		EMR_Delay_Counter;	// The delay before playing EMR message.
...
bool                check_synchronous_loop;   // Denotes whether or not synchronous loop status should be checked in the timer/counter interrupt.
...
unsigned char       I2C_data[3];              // Denotes the data to be received via I2C.
I2C_status_struct   I2C_current_status;       // Denotes the status of I2C.
