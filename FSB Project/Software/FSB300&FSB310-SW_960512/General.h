...
#define         VOL_DEBOUNCE_NUMBER              3      // Denotes the number of times the volume signal needs to be debounced.
...
#define         ALBUM1_FILE_NUMBER              5       // The WAV file number (or the row in page_address[][]) corresponding to the first album.
