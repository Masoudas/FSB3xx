...
unsigned char              I2C_data_counter = 0;                               // Index of the current I2C data being transmitted.
...
void I2C_Receive_Data(unsigned char *I2C_data_pointer, unsigned char I2C_data_length, unsigned char I2C_initiation_mode, bool check_CRC)
{
  ...
  {
    Acknowledge_value = I2C_ACK_NACK_Generation(I2C_data_pointer, I2C_data_counter, I2C_DATA_REGISTER);  // Generate ACK/NACK based on the received data.
